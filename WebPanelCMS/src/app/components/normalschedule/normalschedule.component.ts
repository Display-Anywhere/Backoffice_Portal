...
@Component({
  ...
  templateUrl: './normalschedule.component.html',
  styleUrls: ['./normalschedule.component.css']
})
export class NormalscheduleComponent implements OnInit {
  ScheduleList = [];
  dropdownSettings = {};
  ...
  AddItem() {
    ...
    console.log(this.SFform.value.ScheduleType)
    if (this.SFform.value.ScheduleType != 'PercentageSchedule') {
