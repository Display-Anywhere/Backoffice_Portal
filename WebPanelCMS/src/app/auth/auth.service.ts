...
export class AuthServiceOwn {
  ...
  constructor() {
    ...
    var LoginClientid;
    if ((localStorage.getItem('UserId')=='0') && ((localStorage.getItem('dfClientId') == '6') || (localStorage.getItem('dfClientId') == '88') || (localStorage.getItem('dfClientId') == '201') || (localStorage.getItem('dfClientId') == '98'))) {
      LoginClientid = true;
    }
    else {
      LoginClientid = false;
