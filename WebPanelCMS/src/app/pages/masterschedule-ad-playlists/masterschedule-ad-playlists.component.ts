...
@Component({
  selector: 'app-masterschedule-ad-playlists',
  templateUrl: './masterschedule-ad-playlists.component.html',
  styleUrls: ['./masterschedule-ad-playlists.component.scss'],
  providers: [DecimalPipe],
})
export class MasterscheduleAdPlaylistsComponent implements OnInit {
...
insForm () {
  ...
  this.Plform = this.formBuilder.group({
    ...
    sDateClone: [cd, Validators.required],
    eDateClone: [cd, Validators.required],
  ...
  onSubmitPL  = function (UpdateModel) {
   ...
   // this.Plform.get('startTime').setValue(sTime.toTimeString().slice(0, 5));
    ...
    console.log(this.Plform.value.sDate)
    var sd = new Date(this.Plform.value.sDateClone);
    var ed = new Date(this.Plform.value.eDateClone);
console.log(sd)
console.log(sd.toDateString())
  ...
  clear(){
    ...
    this.Plform.get('sDateClone').setValue(cd);
    this.Plform.get('eDateClone').setValue(cd);
 ...
 //   this.searchText = '';
  ...
  EditClick(id,tokenid,modalName){
    //this.ClearAll()
     ...
     this.aService.FillSavePlaylistAds(id).pipe()
      .subscribe(data => {
        ...
        .subscribe(data => {
          ...
          this.Plform.get('sDateClone').setValue(sd);
          this.Plform.get('eDateClone').setValue(ed);
